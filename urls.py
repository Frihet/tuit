...
urlpatterns = patterns('',
    # Example:
     ...
     (r'^tuit/admin/user/(?P<id>\w+)/remove', 'tuit.ticket.views.user_remove'),
     (r'^tuit/admin/user/(?P<id>\w+)', 'tuit.ticket.views.user_edit'),
     (r'^tuit/admin/user/', 'tuit.ticket.views.user_list'),
